...
/**
 * DLMenuWPPlugin.
 * @author Dave Ligthart <dligthart@gmail.com>
 * @version 0.1
 * @package dlmenu
 * @subpackage util
...
class DLMenuWPPlugin {
	...
	function register_plugin ($name, $base)
	{
		...
		setlocale(LC_TIME, $locale); // time to current locale.

		load_textdomain ($name, $mofile); //load_plugin_textdomain ($domain);
	}
